...
def get_sales_metrics():
    ...
    total_porducts_sold = Outflow.objects.aggregate(total_product_sold=Sum('quantity'))['total_product_sold'] or 0
    ...
    return dict(
        ...
        total_porducts_sold=total_porducts_sold,
...
def get_daily_sales_quantity_data():
    ...
    for date in dates:
        sales_quantity = Outflow.objects.filter(created_at__date=date).count() or 0
