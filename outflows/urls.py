...
urlpatterns = [
    ...
    path('outflows/<int:pk>/detail/', views.OutflowDetailsView.as_view(), name='outflow_detail'),

    path('api/v1/outflows/', views.OutflowCreateListApiView.as_view(), name='outflow-create-list-api-view'),
    path('api/v1/outflows/<int:pk>', views.OutflowRetrieveAPIView.as_view(), name='outflow-deteail-api-view')
]
